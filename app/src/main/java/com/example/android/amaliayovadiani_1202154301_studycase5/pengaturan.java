...
public class pengaturan extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(pengaturan.this, MainActivity.class); //intent baru dari setting ke to do
    ...
    public void pilihWarna(View view) {
        ...
        View view1 = getLayoutInflater().inflate(R.layout.warna, null); //membuat view baru
        alert.setView(view1);
