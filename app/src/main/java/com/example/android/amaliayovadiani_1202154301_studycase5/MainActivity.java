...
public class MainActivity extends AppCompatActivity {
    ...
    public void DeleteSwipe(){ //method untuk dapat menghapus data dengan swipe
        ItemTouchHelper.SimpleCallback touchcall = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
            //membuat touch helper baru untuk recycler view dan swipe kanan untuk menghapus
    ...
    public boolean onOptionsItemSelected(MenuItem item) { //method yang dijalankan ketika item di pilih
        ...
        if (id==R.id.action_settings){
            Intent intent = new Intent(MainActivity.this, pengaturan.class); //membuat intent
    ...
    public void addlist(View view) { //method yang akan dijalankan ketika tombol add di klik
        Intent intent = new Intent(MainActivity.this, tambahanKegiatan.class);
        startActivity(intent);
    }
}
